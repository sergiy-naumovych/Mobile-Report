<div id="new-distributor" style="">
        ...
        <div>
            <div>
                <label for="distributor-name"><?php echo $companies['distributorName']; ?></label>
...
<p>
    <a id="createNewDistributor" class="primaryButton" href="javascript:none();"><?php echo $companies['createNewDistributor']; ?></a>
</p>

<table id="distributors-list" class="content-table">
    <thead>
        <tr>
            <th><?php echo $companies['distributorName']; ?></th>
